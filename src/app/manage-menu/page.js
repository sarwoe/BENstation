...
export default function Home() {
  ...
  // Mencegah menambah ke keranjang jika stok habis (stok <= 0)
            ...
            {filteredProducts.map((product) => {
              ...
              return (
                <div
                  ...
                  className={`bg-white rounded-2xl p-3 border border-neutral-100 transition flex flex-col justify-between ${
                    isOutOfStock 
                      ? 'opacity-60 cursor-not-allowed bg-neutral-100/50' 
                      : 'shadow-sm cursor-pointer hover:border-rose-300 group'
                  }`}
                >
                  <div>
